...
-----------------------------------------------
  ...
  Author : Pulakesh
  Solution Idea:
                It's a A problem, don't think too much just think logically
                don't dare to implement a complete search in this kind of problem
                You will get nothing but TLE
-----------------------------------------------
*/
