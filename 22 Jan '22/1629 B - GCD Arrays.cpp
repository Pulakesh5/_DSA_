...
-----------------------------------------------
  ...
  Author : Pulakesh
 Solution Idea : pair up each odd with a even number in the range
                 look for the cases when it is not possible and possible
                 simple case by case analysis works I think
-----------------------------------------------
*/
